...
import com.example.module_calender.presenter.CalendarCarePresenter
import com.example.module_calender.presenter.CalendarPresenter
import com.haibin.calendarview.Calendar
import com.haibin.calendarview.CalendarView

@Route(path = RouterFragmentPath.CALENDAR)
class CalendarCareFragment: BaseFragment<CalendarPresenter>() {
    private val adapter = CalendarTaskAdapter(R.layout.calendar_care_item_task, null)
    override val mPresenter = CalendarCarePresenter(this)
    override fun init() {
        initCalendar()
        initRecyclerView()
        initPresenter()
    ...
    private fun initRecyclerView(){
        ...
        adapter.setEmptyView(R.layout.calendar_care_empty)
    }
