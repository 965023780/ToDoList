...
import com.example.module_stats.presenter.StatsCarePresenter
...
class StatsCareFragment : BaseFragment<StatsCarePresenter>() {
    override val mPresenter: IBaseContract.IPresenter = StatsCarePresenter(this)
    ...
    override fun getLayoutId(): Int = R.layout.stats_care_fragment_layout
