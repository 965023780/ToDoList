...
import com.example.module_user.presenter.UserPresenter


@Route(path = RouterFragmentPath.USER)
class UserFragment : BaseFragment<UserPresenter>() {
    private val adapter by lazy {
        UserAdapter(requireContext(), R.layout.user_item_setting, null)
    }
